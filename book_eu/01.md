...
Adibidez, programa honek, balioa negatiboa bada, "Balioa 0 baino txikiagoa da" adieraziko du:
...
Baina erabiltzaileak ezer idatzi gabe `enter` tekla sakatu besterik ez badu egiten:
...
1.0 Ariketa
Sortu programa bat erabiltzaileari bi balio oso eskatuko dizkiona non pantaila bidez erakutsiko duena lehenengoa bigarrenaren multiploa den. Zenbaki bat bestearen multiploa den jakiteko, moduluaren eragiketa egin behar duzu (`%`) haien artean: 0 bada, multiploa izango da.
...
Hobespena: saiatu programa motzago egiten `or` operadorerik erabiliz.
...
- GMI 25 eta 30 artean badago (<), mezua agertuko da: "Gorputz gordinagoa duzu".
