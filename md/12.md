...
    if balio1 > balio2:
        diferencia = balio1 - balio2
    else:
        diferencia = balio2 - balio1
...
```Python
def calcular (balio1, balio2, op):
    if op ==  "+": return balio1 + balio2
    elif op == "-": return balio1 - balio2
    elif op == "*": return balio1 * balio2
    elif op == "/": return balio1 / balio2
